...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Textwrap.swiftmodule/`
...
//      `import Textwrap` above would fail at compile time.
//
//   2. The static archive `libTextwrap.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Textwrap" }` and
//      `flattenPackage = "io.github.kotlinmania.textwrap"` configuration in
...
//      via the `TextwrapLibrary` product.
//
...
final class TextwrapExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Textwrap swift module imported cleanly")
    }
}
