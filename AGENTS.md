...
This file is the quick-reference operating contract for textwrap-kotlin. The longer
...
textwrap-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`textwrap`](https://crates.io/crates/textwrap). Upstream Rust is the behavioral oracle while the
