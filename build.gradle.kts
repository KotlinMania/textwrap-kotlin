...
kotlin {
    ...
    val xcf = XCFramework("Textwrap")

    macosArm64 {
        binaries.framework { baseName = "Textwrap"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Textwrap"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Textwrap"
        flattenPackage = "io.github.kotlinmania.textwrap"
    }

    android {
        namespace = "io.github.kotlinmania.textwrap"
        compileSdk = 34
        minSdk = 24
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                implementation("io.github.kotlinmania:hyphenation-kotlin:0.1.0")
            }
        }
...
mavenPublishing {
    ...
    coordinates(group.toString(), "textwrap-kotlin", version.toString())

    pom {
        name.set("textwrap-kotlin")
        description.set("Kotlin Multiplatform port of mgeisler/textwrap - Library for word wrapping, indenting, and dedenting strings. Has optional support for Unicode and emojis as well as machine hyphenation")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/textwrap-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/textwrap-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/textwrap-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/textwrap-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTextwrapXCFramework",
    "assembleTextwrapDebugXCFramework",
    "assembleTextwrapReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTextwrapXCFramework",
    "assembleReleaseIosFatFrameworkForTextwrapXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTextwrapXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTextwrapXCFramework",
    "assembleDebugMacosFatFrameworkForTextwrapXCFramework",
    "assembleReleaseMacosFatFrameworkForTextwrapXCFramework",
    "assembleDebugTvosFatFrameworkForTextwrapXCFramework",
    "assembleReleaseTvosFatFrameworkForTextwrapXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTextwrapXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTextwrapXCFramework",
    "assembleDebugWatchosFatFrameworkForTextwrapXCFramework",
    "assembleReleaseWatchosFatFrameworkForTextwrapXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTextwrapXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTextwrapXCFramework",
